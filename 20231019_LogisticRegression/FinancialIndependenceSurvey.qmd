...
reddit_finance_sub <- reddit_finance_sub %>%
  mutate(total_assets = rowSums(select(., 
    c("home_value","brokerage_accts_tax","retirement_accts_tax","cash","invst_accts","spec_crypto","invst_prop_bus_own","other_val","2020_invst_save"))))
