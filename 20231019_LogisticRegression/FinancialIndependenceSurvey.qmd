...
```{r}
library(pacman)
p_load(openintro, tidyverse,dplyr,tidyr, caret, pROC, e1071)
...
columns <- c("age", "political_grouped", "edu_grouped", "housing", "total_debts", 
...
library(pROC)
roc((reddit_finance_sub$fin_indy),fitted(logistic_mod),print.thres="best",plot=TRUE,print.auc=TRUE)
```

```{r}
confusionMatrix(factor(ifelse(fitted(logistic_mod)>0.067,"Yes","No")),factor(reddit_finance_sub$fin_indy),positive="Yes",mode="everything")
```
...
+-------------------------+-----------------------------------------------------------+
| political               | Transformed into a factor.\                               |
|                         | From the original 24 categories, it was grouped into 4: \ |
|                         | "Democrat"\                                               |
|                         | "Libertarian Party"\                                      |
|                         | "Republican"\                                             |
|                         | "Other"                                                   |
...
+-------------------------+-----------------------------------------------------------+
| edu                     | Transformed into a factor.\                               |
|                         | From the original 11 categories, it was grouped into 4:\  |
|                         | "High School or Less"\                                    |
...
+-------------------------+-----------------------------------------------------------+
| housing                 | Transformed into a factor.\                               |
|                         | From the original 19 categories, it was grouped into 3:\  |
...
+-------------------------+-----------------------------------------------------------+
| brokerage\              | NA replaced with 0\                                       |
| \_accts_tax             | sum in total_assets variable                              |
+-------------------------+-----------------------------------------------------------+
| retirement\             | NA replaced with 0\                                       |
| \_accts_tax             | sum in total_assets variable                              |
+-------------------------+-----------------------------------------------------------+
...
|                         | sum in total_debts variable                               |
+-------------------------+-----------------------------------------------------------+
| credit_personal_loan    | NA replaced with 0\                                       |
|                         | sum in total_debts variable                               |
+-------------------------+-----------------------------------------------------------+
| medical_debt            | NA replaced with 0\                                       |
|                         | sum in total_debts variable                               |
+-------------------------+-----------------------------------------------------------+
| invst_prop_bus_own_debt | NA replaced with 0\                                       |
|                         | sum in total_debts variable                               |
+-------------------------+-----------------------------------------------------------+
...
+-------------------------+-----------------------------------------------------------+
| 2020_housing_exp        | NA replaced with 0\                                       |
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
| 2020_utilities_exp      | NA replaced with 0\                                       |
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
| 2020_transp_exp         | NA replaced with 0\                                       |
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
| 2020_necessities_exp    | NA replaced with 0\                                       |
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
...
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
| 2020_debt_repay         | NA replaced with 0\                                       |
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
...
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
| 2020_healthcare_exp     | NA replaced with 0\                                       |
|                         | sum in total_expenses variable                            |
+-------------------------+-----------------------------------------------------------+
