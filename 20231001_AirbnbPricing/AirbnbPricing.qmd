...
We have a database of various Airbnb rental listings in the city, obtained through web scraping, which contains detailed information about the listings, such as price, number of rooms, amenities, number of bathrooms, property location, etc. The original database includes **75 variables**. This dataset was extracted in June 2023 by the company Inside Airbnb and contains information about **3239** rental listings in Asheville, North Carolina. Therefore, the conclusions drawn are based on this time period.

The database and dictionary can be downloaded from [listings.csv](https://anlane611.github.io/ids702-fall23/DAA/listings.csv) and [Inside Airbnb Data Dictionary](https://docs.google.com/spreadsheets/d/1iWCNJcSutYqpULSQHlNyGInUvHg2BoUGoNRIGa6Szc4/edit#gid=1322284596)

### Data Cleaning

First, the database was cleaned to be used for a linear regression model. Variables that did not contribute information to the model were excluded, such as: "id", "listing_url", "scrape_id", "last_scraped", "source", "name", "description", "neighborhood_overview", "picture_url"," host_id", "host_url", "host_name", "host_location", "host_about", etc.
